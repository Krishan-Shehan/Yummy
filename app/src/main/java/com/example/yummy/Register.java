                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(Register.this, "Congratulations your Yummy Account has been created!!!", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                                        ...
                                        loadingBar.dismiss();
                                        Toast.makeText(Register.this, "Network error occured: Please retry.", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
